...
export default function EssaysClient() {
  ...
  const [lightSeeds, setLightSeeds] = useState<
  ...
  // 뷰포트 크기를 state로 보관 (렌더에서 window 직접 참조 금지)
        ...
        {showModal && (
          ...
          >
            ...
            >
              ...
              <p className="font-playfair text-2xl font-light text-[#dbe8ff]">
